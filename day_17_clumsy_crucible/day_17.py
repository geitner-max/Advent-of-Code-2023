...
if __name__ == '__main__':
    ...
    # 1.) perform path finding algorithm
    stack = [(0, 0, -heat_loss_matrix[0][0], 0, SOUTH)]
    min_heat_loss = -1
    while stack:
        next_stack = []
                ...
                if 0 <= next_x < cols and 0 <= next_y < rows:
                    ...
                    if visited_key in visited.keys():
                        ...
                        if cur_heat_loss < prev_heat_loss:
                            ...
                            # Case: better approximation than before
    ...
    print("Solution Day 17 Part 1: ", min_heat_loss)
    # correct answer: 847
    # runtime: 2-3 minutes
